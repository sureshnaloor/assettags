...
export async function GET() {
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch fixed asset manufacturers' }, { status: 500 });
  }
}
...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to create fixed asset manufacturer' }, { status: 500 });
  }
}
...
export async function PUT(request: Request) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to update fixed asset manufacturer' }, { status: 500 });
  }
}
...
export async function DELETE(request: Request) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to delete fixed asset manufacturer' }, { status: 500 });
  }
}
