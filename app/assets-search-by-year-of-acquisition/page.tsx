      ...
      <div className="relative z-20 flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6 min-h-screen">
        ...
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 shadow-xl">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-teal-400 bg-clip-text text-transparent mb-2">
            Fixed Assets Search by Year of Acquisition
          </h1>
          <p className="text-white/80 text-lg">Search for fixed assets by acquisition year</p>
        </div>
        ...
        <div className="mb-6 p-6 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-xl">
          ...
          <p className="mt-3 text-xs text-white/70">Select a year to search for fixed assets acquired in that year.</p>
        </div>
          ...
          {loading ? (
            ...
            <>
              <div className="px-4 py-2 border-b border-white/20">
                <p className="text-sm text-white/80">Found {data.length} fixed asset{data.length !== 1 ? 's' : ''} acquired {selectedYear === 'pre-2010' ? 'before 2010' : `in ${selectedYear}`}</p>
              </div>
